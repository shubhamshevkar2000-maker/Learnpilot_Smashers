...
function SettingsContent() {
  ...
  const [availableDailyMinutes, setAvailableDailyMinutes] = useState<number>(45)
  ...
  const loadProfile = useCallback(async () => {
    ...
    try {
      ...
      if (data) {
        ...
        setCurrentLevel((data.current_level as CurrentLevel) || "beginner")
        setAvailableDailyMinutes(data.available_daily_minutes || 45)
        if (data.target_date) {
  ...
  const handleReset = () => {
    ...
    setCurrentLevel((initialProfile.current_level as CurrentLevel) || "beginner")
      ...
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="font-serif text-2xl font-normal tracking-tight text-foreground sm:text-3xl mt-0.5">
              Personalized Learning Controls
            </h1>
          </div>
        </div>
